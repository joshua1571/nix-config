...

{
  ...
  systemd.tmpfiles.rules = [
    ...
    "d /tank/media/usenet/incomplete   			0755 ${username} users -"
    "d /tank/media/usenet/complete/books    0755 ${username} users -"
    "d /tank/media/usenet/complete/movies   0755 ${username} users -"
    "d /tank/media/usenet/complete/music    0755 ${username} users -"
    "d /tank/media/usenet/complete/tv       0755 ${username} users -"
    "d /tank/media/usenet/complete/games    0755 ${username} users -"

    "d /tank/media/books										0755 ${username} users -"
    "d /tank/media/movies              			0755 radarr radarr -"
    "d /tank/media/music               			0755 lidarr lidarr -"
    "d /tank/media/tv                  			0755 sonarr sonarr -"
    "d /tank/media/games               			0755 ${username} users -"
